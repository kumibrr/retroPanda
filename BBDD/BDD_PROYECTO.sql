...
CREATE TABLE JUEGO (
	...
	GENERO2 ENUM ('ACCION','SHOOTER','ESTRATEGIA','SIMULACION','DEPORTES','CARRERAS','AVENTURAS','ROL') NOT NULL,
	GENERO3 ENUM ('ACCION','SHOOTER','ESTRATEGIA','SIMULACION','DEPORTES','CARRERAS','AVENTURAS','ROL') NOT NULL,
	GENERO4 ENUM ('ACCION','SHOOTER','ESTRATEGIA','SIMULACION','DEPORTES','CARRERAS','AVENTURAS','ROL') NOT NULL,
	FECHA_PUBLICACION DATE NOT NULL,
	REGION1 VARCHAR(50) NOT NULL,
	REGION2 VARCHAR(50) NOT NULL,
	REGION3 VARCHAR(50) NOT NULL,
	REGION4 VARCHAR(50) NOT NULL,
